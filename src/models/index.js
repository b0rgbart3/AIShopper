...
// console.log("ENVIRONMENT VARS: ", env_variables);
console.log("----------------------");
console.log("The NODE Environment: ", env);

const DB_HOST = env_variables["JAWSDB_URL"] || "localhost";
const DB_NAME = env_variables["SHOPPR_DB"];
const DB_USER = env_variables["SHOPPR_DB_USER"];
const DB_PASS = env_variables["SHOPPR_PASS"];
...
async function connectToDB() {
  try {
    ...
    console.log(
      "Sequelize Connection to the DB has been established successfully."
    );
  } catch (error) {
